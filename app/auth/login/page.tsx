          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-zinc-400 cursor-pointer">
                <input 
                  type="checkbox" 
                  className="accent-[#2B3494] w-4 h-4" 
                />
                Remember me
              </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full h-12 rounded-2xl bg-gradient-to-r from-[#2B3494] to-indigo-800 text-white font-semibold text-base tracking-wide transition-all hover:brightness-110 active:scale-[0.985] disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-[#2B3494]/30"
            >
              {loading ? (
