        ...
        <div className='rounded-3xl border border-zinc-800/80 bg-zinc-950/90 p-8 sm:p-10 shadow-2xl backdrop-blur-2xl'>
          ...
          <div className='mb-8 flex flex-col items-center text-center'>
            ...
            <p className='text-zinc-400 mt-2'>
              Join thousands of happy Maruti families
            </p>
          </div>
          ...
          <div className='mb-8'>
            <div className='h-1.5 w-full bg-zinc-800 rounded-full overflow-hidden'>
              <div
                className='h-full bg-[#2B3494] transition-all duration-300'
          ...
          >
                ...
                <div className='space-y-5'>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className='h-12 w-full rounded-2xl border border-zinc-800 bg-zinc-900 px-4 text-white focus:border-[#2B3494] outline-none'
                      placeholder='₹ 8 - 15 Lakh'
                    />
                  </div>
                </div>
              </>
                ...
                <div className='space-y-5'>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className='w-full resize-y rounded-2xl border border-zinc-800 bg-zinc-900 p-4 text-white focus:border-[#2B3494] outline-none'
            ...
            <div className='flex gap-4 pt-6'>
              {step > 1 && (
                <button
                  type='button'
                  onClick={prevStep}
                  className='flex-1 h-12 rounded-2xl border border-zinc-700 hover:bg-zinc-900 text-white font-medium transition'
                >
                  Previous
                </button>
              )}
              ...
              {step < 3 ? (
                <button
                  type='submit'
                  className='flex-1 h-12 rounded-2xl bg-linear-to-r from-[#2B3494] to-indigo-800 text-white font-semibold transition hover:brightness-110'
                >
                  Continue
                </button>
              ) : (
                <button
                  type='submit'
                  disabled={loading}
                  className='flex-1 h-12 rounded-2xl bg-linear-to-r from-[#2B3494] to-indigo-800 text-white font-semibold transition hover:brightness-110 disabled:opacity-70'
                >
            ...
            {step === 2 || step === 3 ? (
              <button
                ...
                className='w-full text-center text-sm text-zinc-400 hover:text-zinc-300 transition'
              >
                Skip for now →
              </button>
            ) : null}
