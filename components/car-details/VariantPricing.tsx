...
export default function VariantPricing ({ variants, vehicleId }: Props) {
  ...
  const handleGetOnRoadPrice = (variant: Variant) => {
  ...
  return (
    <>
            ...
            >
              <div className='flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between'>
                ...
                <div className='flex flex-col items-start gap-3 lg:items-end lg:text-right'>
                  ...
                  <button
                    onClick={() => handleGetOnRoadPrice(variant)}
      ...
      <OnRoadPriceSheet
        ...
        onClose={() => setPriceSheet({ open: false, basePrice: 0 })}
        vehicleId={vehicleId}
        variantId={priceSheet.variantId}
        variantName={priceSheet.variantName}
        basePrice={priceSheet.basePrice}
      />
    </>
  )
}